...
module.exports = "<div class=\"container\" role=\"main\">\r\n  <a routerLink=\"/pessoa\">Pessoa2</a>\r\n  <router-outlet></router-outlet>\r\n</div>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pessoa_pessoa_component__ = __webpack_require__("../../../../../src/app/pessoa/pessoa.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pessoa_pessoa_service__ = __webpack_require__("../../../../../src/app/pessoa/pessoa.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    {
        path: 'pessoa',
        component: __WEBPACK_IMPORTED_MODULE_5__pessoa_pessoa_component__["a" /* PessoaComponent */]
    },
    {
        path: 'carro',
        component: __WEBPACK_IMPORTED_MODULE_5__pessoa_pessoa_component__["a" /* PessoaComponent */]
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__pessoa_pessoa_component__["a" /* PessoaComponent */]
            ],
            imports: [
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_6__pessoa_pessoa_service__["a" /* PessoaService */]],
...
module.exports = "<table style=\"width:50%;border:1px solid;\">\r\n\t<th>Nome</th>\r\n\t<th>Idade</th>\r\n\t<th>CPF</th>\r\n\t<th>Telefone</th>\r\n\t<tr *ngFor=\"let item of pessoas\" align=\"center\">\r\n\t\t<td>{{item.nome}}</td>\r\n\t\t<td>{{item.idade}}</td>\r\n\t\t<td>{{item.cpf}}</td>\r\n\t\t<td>{{item.telefone2}}</td>\r\n\t</tr>\r\n<table>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pessoa_service__ = __webpack_require__("../../../../../src/app/pessoa/pessoa.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PessoaComponent = (function () {
    ...
    Object.defineProperty(PessoaComponent.prototype, "pessoas", {
        get: function () {
    ...
    PessoaComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.pessoaService.getPessoas().subscribe(function (data) {
            _this.pessoas = data;
